...
const ProjectCard = ({ project, onViewDetails }) => {
  return (
    <motion.div
      ...
      className="glass-card rounded-2xl overflow-hidden group flex flex-col h-full hover:border-cyan-400/60 hover:shadow-[0_0_20px_rgba(34,211,238,0.3)] transition-all duration-300 cursor-pointer"
